...
if __name__ == '__main__':
    ...
    ROOT_DIR = 'C:/Users/Mint/Desktop/CSI_GAN'
...
#%%    
    ...
    # your code
    #-----------------------------------------------------
    outputs = tf.keras.layers.Dense(2, activation=tf.nn.softmax)(# your code) 
    model2 = tf.keras.models.Model(inputs=inputs, outputs=outputs)
    model2.compile(loss="categorical_crossentropy", optimizer = 'Adam', metrics=['accuracy'])   
    #model.compile(loss="categorical_crossentropy", optimizer=keras.optimizers.Adadelta(learning_rate=0.05,rho=0.95,decay=0.00001), metrics=['accuracy']) 
